...
def fl_collude_byzantine_attacker(gf, round, aggregation_method, m, r, k, weight):
  ...
  model_error_array = []
  tmp_weight = weight
  acc_filename = "result_data/cifar/byzantine_attacker_collude/acc_"+aggregation_method
  err_filename = "result_data/cifar/byzantine_attacker_collude/err_"+aggregation_method
  ...
  if (aggregation_method == "sar"):
    acc_filename += "_r:"+str(r)+"_k:"+str(k)+"b=1"
    err_filename += "_r:"+str(r)+"_k:"+str(k)+"b=1"
